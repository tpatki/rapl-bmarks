...
lines(d$pkg.clamp.0[d$bmark=="sphot"], d$avg.time[d$bmark=="sphot"], cex=0.4, col="blue",type="o", lwd=0.5,pch=15)
lines(d$pkg.clamp.0[d$bmark=="btmz"], d$avg.time[d$bmark=="btmz"], cex=0.4, col="darkgreen",type="o", lwd=0.5,pch=17)
lines(d$pkg.clamp.0[d$bmark=="lumz"], d$avg.time[d$bmark=="lumz"], cex=0.4, col="black",type="o", lwd=0.5,pch=18)

text(118,6.5,"btmz", col="black", cex=0.45)
text(119,3.5,"spmz", col="black", cex=0.45)
text(122,10,"lumz", col="black", cex=0.45)
text(122,33,"sphot", col="black", cex=0.45)
